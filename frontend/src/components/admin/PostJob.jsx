...
const PostJob = () => {
	...
	const submitHandler = async (e) => {
		...
		try {
			setLoading(true);
			const res = await axios.post(`${JOB_API_ENDPOINT}/register`, input, {
				headers: {
	...
	return (
		<div>
			...
			<div className='flex items-center justify-center w-screen my-5'>
				<form className='p-5 max-w-4xl border border-gray-300 shadow-xl rounded-md' onSubmit={submitHandler}>
